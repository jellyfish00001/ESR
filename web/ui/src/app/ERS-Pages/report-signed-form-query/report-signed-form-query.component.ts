...
import { SignFormDetail } from './classes/data-item';
...
@Component({
  selector: 'app-report-signed-form-query',
  templateUrl: './report-signed-form-query.component.html',
  styleUrls: ['./report-signed-form-query.component.scss']
})

export class ReportSignedFormQueryComponent implements OnInit {
  DetailTableColumn: TableColumnModel[] = [
    {
      ...
      columnWidth: '70px',
      align: 'center',
      sortFn: (a: SignFormDetail, b: SignFormDetail) =>
    ...
    },
    {
      ...
      columnWidth: '130px',
      align: 'center',
      sortFn: (a: SignFormDetail, b: SignFormDetail) => a.rno.localeCompare(b.rno),
    },
    {
      ...
      columnWidth: '110px',
      align: 'left',
      sortFn: (a: SignFormDetail, b: SignFormDetail) => a.formTypeName.localeCompare(b.formTypeName),
    },
    {
      ...
      columnWidth: '90px',
      align: 'center',
      sortFn: (a: SignFormDetail, b: SignFormDetail) => a.appliedDept.localeCompare(b.appliedDept),
    },
    {
      ...
      columnWidth: '100px',
      align: 'center',
      sortFn: (a: SignFormDetail, b: SignFormDetail) => a.applicant.localeCompare(b.applicant),
    },
    {
      ...
      columnWidth: '110px',
      align: 'center',
      sortFn: (a: SignFormDetail, b: SignFormDetail) => a.applicantName.localeCompare(b.applicantName),
    },
    {
      ...
      columnWidth: '90px',
      align: 'center',
      sortFn: (a: SignFormDetail, b: SignFormDetail) => a.appliedDate.localeCompare(b.appliedDate),
    },
    {
      ...
      columnWidth: '',
      align: 'left',
      sortFn: (a: SignFormDetail, b: SignFormDetail) => a.expenseType.localeCompare(b.expenseType),
    },
    {
      ...
      columnWidth: '120px',
      align: 'center',
      sortFn: (a: SignFormDetail, b: SignFormDetail) => a.dept.localeCompare(b.dept),
    },
    {
      ...
      columnWidth: '60px',
      align: 'center',
      sortFn: (a: SignFormDetail, b: SignFormDetail) => a.curr.localeCompare(b.curr),
    },
    {
      ...
      columnWidth: '',
      align: 'right',
      sortFn: (a: SignFormDetail, b: SignFormDetail) => a.actualAmount.localeCompare(b.actualAmount),
    },
    {
      ...
      columnWidth: '100px',
      align: 'center',
      sortFn: (a: SignFormDetail, b: SignFormDetail) => a.step.localeCompare(b.step),
    },
    {
      ...
      columnWidth: '90px',
      align: 'center',
      sortFn: (a: SignFormDetail, b: SignFormDetail) => a.payment.localeCompare(b.payment),
    },
  ];
  ...
  detailTableData: SignFormDetail[] = [];
  isSpinning = false;
  queryParam: any;
  userInfo: any;
  total: any;
  ...
  formInitial(): void {
    ...
    this.queryForm = this.fb.group({
      ...
      approverEmplid: [{ value: null, disabled: true }],
    ...
    this.queryForm.controls.approverEmplid.setValue(this.userInfo?.emplid);
    this.authService.CheckPermissionByRole(['Admin', 'FinanceAdmin']).subscribe(hasPermission => {
      ...
      if (hasPermission && this.queryForm.controls.approverEmplid.disabled) { this.queryForm.controls.approverEmplid.enable(); }
  ...
  autoTips: Record<string, Record<string, string>> = {
    default: {
      ...
      sdate: this.translate.instant('can-not-later-than-end-date'),
      edate: this.translate.instant('can-not-earlier-than-start-date'),
    }
  };
  ...
  queryResultWithParam(initial: boolean = false) {
    ...
    this.queryParam = {
      ...
      data: {
        ...
        aemplid: paramValue.approverEmplid,
  ...
  download() {
    if (this.queryParam != null) {
      this.Service.doPost(this.EnvironmentconfigService.authConfig.ersUrl + URLConst.DownloadSignedForm, this.queryParam, true).subscribe((res) => {
        this.downloadFlow(res, `${this.translate.instant('SignedReport')}-${format(new Date(), 'yyyyMMdd')}.xlsx`);
      });
    }
  }
