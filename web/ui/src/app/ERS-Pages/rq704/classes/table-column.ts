...
export const SalaryTableColumn: TableColumnModel[] = [
  {
    ...
    columnWidth: '7%',
    align: 'center',
    sortFn: (a: SalaryInfo, b: SalaryInfo) => a.company.localeCompare(b.company),
  },
  {
    ...
    columnWidth: '11%',
    align: 'center',
    sortFn: (a: SalaryInfo, b: SalaryInfo) => a.sceneName.localeCompare(b.sceneName),
  },
  {
    ...
    columnWidth: '8%',
    align: 'center',
    sortFn: (a: SalaryInfo, b: SalaryInfo) => a.feeDate.localeCompare(b.feeDate),
  },
  {
    title: 'salary-month',
    ...
    columnWidth: '10%',
    align: 'center',
    sortFn: (a: SalaryInfo, b: SalaryInfo) => a.salaryMonth.localeCompare(b.salaryMonth),
  },
  {
    title: 'bank',
    columnKey: 'bank',
  ...
  },
  {
    ...
    columnWidth: '7%',
    align: 'center',
    sortFn: (a: SalaryInfo, b: SalaryInfo) => a.requestPayment.localeCompare(b.requestPayment),
  },
  {
    title: 'col.currency',
    columnKey: 'curr',
  ...
  },
  {
    ...
    columnWidth: '11%',
    align: 'right',
    sortFn: (a: SalaryInfo, b: SalaryInfo) => a.actualAmount - b.actualAmount,
  },
  {
    title: 'digest',
    columnKey: 'digest',
